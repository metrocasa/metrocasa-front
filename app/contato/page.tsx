  ...
  return (
    <>
      <div>
        ...
        <div className="w-full max-w-[1216px] mx-auto py-24 flex justify-between items-center">
          {/* LEFT */}
          <div className="flex flex-col gap-6 max-w-[50%]">
            ...
            {contatoInfo.map((info, i) => (
              <div key={i}>
                ...
                <h3 className="font-bold text-2xl text-main-red">
                  {info.value}
                </h3>
              </div>
            ))}
          ...
          {/* RIGHT */}
          <MainForm className="flex-col w-[500px]" variant={'primary'} />
        </div>
